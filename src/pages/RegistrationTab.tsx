                  ...
                  <div className="mt-[0.75rem] flex flex-col gap-[1.25rem] ">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <Input
                        ...
                        placeholder=""
                        onChange={handleRegFields}
                        className="h-12 w-full pl-[0.75rem] border border-border  rounded-lg text-[1rem] text-ipcol overflow-hidden"
                        isReadOnly={true}
                      />
                    </div>
                    <div className="flex flex-col gap-1">
                      ...
                      <Input
                        ...
                        value={
                          activeSCDetails?.serviceCenterOwnerName as string
                        }
                        placeholder=""
                        onChange={handleRegFields}
                        className="h-12 w-full pl-[0.75rem] border border-border  rounded-lg text-[1rem] text-ipcol overflow-hidden"
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      >
                        ...
                        <Input
                          ...
                          value={
                            activeSCDetails?.serviceCenterAddress as string
                          }
                          placeholder=""
                          onChange={handleRegFields}
                          className="outline-none w-full overflow-hidden whitespace-nowrap text-ellipsis max-w-[80%] "
                          isReadOnly={true}
                        />
                      </div>
                      {showMap && (
